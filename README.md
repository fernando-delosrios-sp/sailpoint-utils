...
| [Demo Data](ISC/Demo%20Data/) | Tenant-seeded demo access model: delimited sources, birthright title/department roles, dimensional Workplace User with city dimensions, and conflicting-access SoD policies |
