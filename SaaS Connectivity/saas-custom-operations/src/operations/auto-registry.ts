...
import { accessExpirationRemindersOperation } from './access-expiration-reminders/index'
...
import { accessExpirationRemindersOperationSchema } from './access-expiration-reminders/index.schema'
...
registerOperationSchema('custom:access-expiration-reminders', accessExpirationRemindersOperationSchema)
...
export const OPERATION_HANDLERS: Record<string, CommandHandler> = {
    'custom:access-expiration-reminders': accessExpirationRemindersOperation,
...
export function registerAutoOperations(connector: Connector): Connector {
    return connector.command('custom:access-expiration-reminders', accessExpirationRemindersOperation).command('custom:access-model-sod-remediation', accessModelSodRemediationOperation).command('custom:access-model-sod-remediation-apply', accessModelSodRemediationApplyOperation).command('custom:access-request-status', accessRequestStatusOperation).command('custom:access-request-threshold', accessRequestThresholdOperation).command('custom:check-sod-pending', checkSodPendingOperation).command('custom:example', exampleOperation).command('custom:governance-group-emails', governanceGroupEmailsOperation).command('custom:preventive-sod-check', preventiveSodCheckOperation).command('custom:sod-remediation', sodRemediationOperation)
}
