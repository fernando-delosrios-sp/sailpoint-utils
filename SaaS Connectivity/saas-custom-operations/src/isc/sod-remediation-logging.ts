import { IdentityAccessItem, ResolvedAccessSide } from './access-path-resolver'
import { CompensatingControlV1, ViolationV1 } from './experimental-client'
...
export function logSodRemediationFormInput(requestId: string, formInput: SodFormInputValues): void {
    logStep(requestId, 'form-input', {
        ...
        groupADisplay: formInput.groupADisplay,
        groupBDisplay: formInput.groupBDisplay,
