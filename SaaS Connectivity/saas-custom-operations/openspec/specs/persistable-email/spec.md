# persistable-email Specification

## Purpose
Shared builders for compact HTML email snippets that fit ISC STRING persist limits (workflow Send Email bodies), distinct from in-form SoD DESCRIPTION HTML.
