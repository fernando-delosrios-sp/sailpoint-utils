# form-launch Specification

## Purpose
Shared choreography to ensure a seeded form definition, create a standalone form instance, and produce a form notification envelope. Persistence and recipient policy stay with operation handlers.
