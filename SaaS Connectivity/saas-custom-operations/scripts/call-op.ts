...
/** Handler map generated by `npm run codegen:schemas` — same commands as connector registration. */
 ...
 * Defaults to codegen `OPERATION_HANDLERS`; pass an override map in tests.
 */
