...
- **Access-model SoD scan performance** — `custom:access-model-sod-remediation` memoizes policy-owner email resolution and caches access-item entitlement expansion within the scan loop to reduce ISC API volume on large catalogs.
