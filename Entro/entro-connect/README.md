...
| `skills/` | Symlink to repo-root [`skills/`](../../skills/) (`../../skills`). Holds the installable `entro-connect` skill tree for `npx skills add fernando-delosrios-sp/sailpoint-utils --skill entro-connect`. The catalog writer keeps this tree in sync with `.agents/skills/entro-connect/`. |
