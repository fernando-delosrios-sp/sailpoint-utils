...
At any fork, confirmation, permission pause, or value you need from the user, present the choices via the **structured-choices** skill — one gate per message, recommended option first, options carried by the call rather than restated in chat.
